...
void setup()
{
  ...
  //Init variable action_reset when is bigger than 100, because is allways bigger when there are hard resets.
  if (action_reset>100){
    action_reset=0;
  }
